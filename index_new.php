    ...
    <div class="pd-ltr-20">
        ...
        <div class="content-wrapper">
                ...
                <div class="col-md-6">
                    <div class="card-custom" style="background:#00BCD4;">
                        <h5>
                            ...
                            $totalsitesQry = mysqli_query($con, "select count(*) as totalSites from ai_alerts");
                        ...
                        <p class="text-uppercase m-b-5 font-13 font-600"><a href="" style="color:white"
                                target="_blank">Total AI Alerts</a></p>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="card-custom" style="background:#2196F3;">
                        <h5 style="margin:5px 0;">
                            <?php
                            $checkcomfortQry = mysqli_query($con, "select count(distinct(ATMCode)) as totalCount from ai_alerts ");
                            $totalComfortPanel = mysqli_fetch_assoc($checkcomfortQry)['totalCount'];

                            echo $totalComfortPanel;
                            ?>
                        </h5>
                        <p class="text-uppercase m-b-5 font-13 font-600" style="margin:0;"><a href="index_new.php"
                                style="color:white" target="_blank">Total ATMID</a>
                        </p>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                $checksHelmetQry = mysqli_query($con, "select count(*) as totalConnect from ai_alerts where alerttype='Helmet'");
                $AlertTypeHelmet = mysqli_fetch_assoc($checksHelmetQry)['totalConnect'] ?? 0;

                $checkscameraTemperQry = mysqli_query($con, "select count(*) as totalConnect from ai_alerts where alerttype='Camera-Temper' ");
                $AlerttypecameraTemper = mysqli_fetch_assoc($checkscameraTemperQry)['totalConnect'] ?? 0;

                $checkMaskQry = mysqli_query($con, "select count(*) as totalConnect from ai_alerts where alerttype='Mask' ");
                $AlerttypeMask = mysqli_fetch_assoc($checkMaskQry)['totalConnect'] ?? 0;

                $checkmultiQry = mysqli_query($con, "select count(*) as totalConnect from ai_alerts where alerttype='Multi' ");
                $AlerttypeMulti = mysqli_fetch_assoc($checkmultiQry)['totalConnect'] ?? 0;

                $checkOverstayQry = mysqli_query($con, "select count(*) as totalConnect from ai_alerts where alerttype='Overstay' ");
                $AlertTypeOverstay = mysqli_fetch_assoc($checkOverstayQry)['totalConnect'] ?? 0;

                // echo $AlertTypeHelmet;
            ...
            <div class="pd-ltr-20 xs-pd-20-10">
                <div class="min-height-200px">
                    ...
                    <div class="bg-white pd-20 card-box mb-30" id="AlerttypePie"></div>
